...
/**
 * Vista para la gestión de contenido académico por administradores.
 *
 * Funcionalidades:
 * 1. Listar todos los recursos del sistema.
 * 2. Navegar al editor de recursos (`ResourceEditorPage`).
 * 3. Archivar, desarchivar y eliminar recursos.
 */
export const ManageResourcesView = () => {
  ...
  const handleEdit = (resourceId: string) => {
    navigate(`/admin/content/${resourceId}`);
  };
