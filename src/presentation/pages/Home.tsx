...
import { HomeNavbar } from "@presentation"; // Importar HomeNavbar
import { Box } from "@mui/material"; // Importar Box para envolver el contenido
...
export const Home = () => {
  ...
  return (
    <Box> {/* Usar Box como contenedor principal */}
      <HomeNavbar /> {/* Renderizar el HomeNavbar en la parte superior */}
